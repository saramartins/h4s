...
var kommun = "";
  ...
  if(nrOfRooms == 1)
  {
    kommun += " " + x[0].getElementsByTagName("kommunnamn")[0].childNodes[0].nodeValue + "  | 212 apartments with " + nrOfRooms + " room available";
  }
  else 
  {
    kommun += " " + x[0].getElementsByTagName("kommunnamn")[0].childNodes[0].nodeValue + "  | 25 apartments with " + nrOfRooms + " rooms available";
  }
...
if(nrOfRooms ==1)
{
   kommun1 += " " + x[1].getElementsByTagName("kommunnamn")[0].childNodes[0].nodeValue + "  | 212 apartments with " + nrOfRooms + " room available";
}
else
{
   kommun1 += " " + x[1].getElementsByTagName("kommunnamn")[0].childNodes[0].nodeValue + "  | 25 apartments with " + nrOfRooms + " rooms available";
}
